...
Cette couche prend en charge l'intégration de l'application de détection et de classification des véhicules à partir d'une vidéo, avec l'envoi de messages MQTT contenant un JSON pour chaque véhicule détecté dans l'image. Ce développement est destiné à l'environnement Yocto, dédié aux cartes embarquées utilisant l'architecture x86.
